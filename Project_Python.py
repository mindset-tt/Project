...
txt = tk.Entry(window,width=70  ,bg="yellow" ,fg="red",font=('times', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="Enter Name",width=20  ,fg="red"  ,bg="yellow"    ,height=2 ,font=('times', 15, ' bold ')) 
lbl2.place(x=400, y=300)

txt2 = tk.Entry(window,width=70  ,bg="yellow"  ,fg="red",font=('times', 15, ' bold ')  )
txt2.place(x=700, y=315)

lbl3 = tk.Label(window, text="Notification : ",width=20  ,fg="red"  ,bg="yellow"  ,height=2 ,font=('times', 15, ' bold underline ')) 
lbl3.place(x=400, y=400)

message = tk.Label(window, text="" ,bg="yellow"  ,fg="red"  ,width=70  ,height=4, activebackground = "yellow" ,font=('times', 15, ' bold ')) 
...
message2 = tk.Label(window, text="" ,fg="red"   ,bg="yellow",activeforeground = "green",width=70  ,height=10  ,font=('times', 15, ' bold ')) 
...
clearButton.place(x=1450, y=200)
...
clearButton2.place(x=1450, y=300)    
